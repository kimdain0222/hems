    ...
    <Card.Content>
      ...
      <View style={styles.gradeContainer}>
        <View style={{
          ...
          alignItems: 'center',
          borderWidth: 8,
          borderColor: getEfficiencyColor(energyData.efficiencyGrade),
        }}>
          <Text style={{
            fontSize: 16,
            fontWeight: 'bold',
            color: getEfficiencyColor(energyData.efficiencyGrade),
          }}>
            {getEfficiencyScore(energyData.efficiencyGrade)}%
          </Text>
        </View>
